...
(
  ...
  test "$("$bin_dir/codex-streamctl" --version)" = "codex-streamctl 0.1.3"
  test "$("$bin_dir/codex-threadctl" --version)" = "codex-threadctl 0.5.3"
  test "$("$bin_dir/codex-wakectl" --version)" = "codex-wakectl 0.3.9"
)
