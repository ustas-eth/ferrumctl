...
(
  ...
  test "$("$bin_dir/codex-goalctl" --version)" = "codex-goalctl 0.1.7"
  test "$("$bin_dir/codex-limitctl" --version)" = "codex-limitctl 0.2.5"
  test "$("$bin_dir/streamctl" --version)" = "streamctl 0.2.0"
  test "$("$bin_dir/codex-threadctl" --version)" = "codex-threadctl 0.5.4"
  test "$("$bin_dir/codex-wakectl" --version)" = "codex-wakectl 0.3.10"
)

run packages/codex-readcov/target/debug/codex-readcov --version
test "$(packages/codex-readcov/target/debug/codex-readcov --version)" = "codex-readcov 0.1.6"
