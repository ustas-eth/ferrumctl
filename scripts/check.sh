...
(
  ...
  test "$("$bin_dir/codex-limitctl" --version)" = "codex-limitctl 0.1.0"
  test "$("$bin_dir/codex-threadctl" --version)" = "codex-threadctl 0.3.1"
  test "$("$bin_dir/codex-wakectl" --version)" = "codex-wakectl 0.3.4"
)
