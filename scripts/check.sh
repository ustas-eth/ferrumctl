...
(
  ...
  test "$("$bin_dir/codex-goalctl" --version)" = "codex-goalctl 0.1.5"
  test "$("$bin_dir/codex-limitctl" --version)" = "codex-limitctl 0.2.2"
  test "$("$bin_dir/codex-streamctl" --version)" = "codex-streamctl 0.1.1"
  test "$("$bin_dir/codex-threadctl" --version)" = "codex-threadctl 0.5.1"
  test "$("$bin_dir/codex-wakectl" --version)" = "codex-wakectl 0.3.7"
)

run packages/codex-readcov/target/debug/codex-readcov --version
test "$(packages/codex-readcov/target/debug/codex-readcov --version)" = "codex-readcov 0.1.4"
